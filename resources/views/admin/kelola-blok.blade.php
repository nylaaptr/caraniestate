...
<head>
    ...
    <title>Kelola Blok - Carani Estate</title>
...
<body>
    ...
    <div class="main-content">
        <!-- Header -->
        <div class="header">
            <h1 class="page-title">Kelola Blok - {{ $perumahan->nama_perumahan }}</h1>
        ...
        <!-- SEARCH BLOK -->
        <form method="GET"
            action="{{ route('admin.kelola-blok', $perumahan->id_perumahan) }}"
            id="searchForm">
        ...
        <div class="data-table-container">
            <div class="table-header">
                <div class="table-title">
                    Daftar Blok - {{ $perumahan->nama_perumahan }}
                </div>

                <div class="table-actions">
                    <a href="{{ route('admin.perumahan') }}" class="btn-action btn-secondary">
                        <i class="fas fa-arrow-left"></i> Kembali
                    </a>
                    <!-- TAMBAH BLOK (HARUS ADA ID PERUMAHAN) -->
                    <button type="button"
                            class="btn-action btn-primary"
                            onclick="openTambahBlokModal()">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-group">
                                    ...
                                    <!-- DELETE -->
                                    <form method="POST"
                                        action="{{ route('admin.hapus-blok', $b->id_blok) }}"
    ...
    <!-- JS MODAL TAMBAH -->
     <script>
        function openTambahBlokModal() {
            document.getElementById('tambahBlokModal').style.display = 'block';
        }

        function closeTambahBlokModal() {
            document.getElementById('tambahBlokModal').style.display = 'none';
        }

        // klik luar modal untuk close
        window.addEventListener('click', function(e) {
            const modal = document.getElementById('tambahBlokModal');
            if (e.target === modal) {
    ...
    <!-- JS MODAL EDIT-->
     <script>
        function openEditModal(button) {
            ...
            document.getElementById('editNamaBlok').value = nama;

            // set action form ke route update
            document.getElementById('editBlokForm').action = "{{ route('admin.update-blok', ':id') }}".replace(':id', id);

            document.getElementById('editBlokModal').style.display = 'block';
        }

        function closeEditModal() {
            document.getElementById('editBlokModal').style.display = 'none';
        }

        // klik luar modal untuk close
        window.onclick = function(event) {
            let modal = document.getElementById('editBlokModal');
...
<!-- TAMBAH BLOK MODAL -->
<div id="tambahBlokModal" class="modal">

    <div class="modal-content">

        <div class="modal-header">
            <h3>Tambah Blok</h3>
            <span class="close" onclick="closeTambahBlokModal()">&times;</span>
        </div>

        <form method="POST"
              action="{{ route('admin.tambah-blok', $perumahan->id_perumahan) }}">
            ...
            <div class="modal-body">
                ...
                <div class="hint">
                    Pastikan nama blok sesuai standar perumahan
                </div>
...
<!-- EDIT BLOK MODAL -->
<div id="editBlokModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <form id="editBlokForm" method="POST">
            @csrf
            @method('PUT')
